...
public class StreetArray {
    public static void StreetBuilder() {
        ...
        streetArray[5] = new Street("Klinina");
        streetArray[6] = new Street("Oktyabrya");
        streetArray[7] = new Street("Kirova");
        streetArray[8] = new Street("Komarova");
        streetArray[9] = new Street("Ivanova");
        streetArray[10] = new Street("Pavlova");
        streetArray[11] = new Street("Cherry");
